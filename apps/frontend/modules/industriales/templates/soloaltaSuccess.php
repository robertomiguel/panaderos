...
<h1>Asociación de industriales panaderos<br>Fondo convencional ordinario<br>Listado de solo activos</h1>
<center><b>Total de empleadores: <?php echo count($empleadores); ?></b></center>
<div>
<a href="/industriales/index">Listado completo</a> - <a href="/industriales/solobaja">Listar solo empleadores inactivos</a>
</div>

<div style="position:absolute;left:5px" class="tablaRecuadro">
<table id="ordenar" style="width:1000px">
<thead>
<th>CUIT</th>
<th>NOMBRE</th>
