...
/**
 * BoletaSindical filter form base class.
 *
 * @package    panaderos
 * @subpackage filter
 ...
 */
abstract class BaseBoletaSindicalFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('boleta_sindical_filters[%s]');
